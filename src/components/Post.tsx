...
const Post: React.FC<PostProp> = (post) => {
    return (
        <a href={`/posts/${post.id}`} className="not-format no-underline hover:no-underline gap-8 mx-auto max-w-screen-xl w-full flex flex-col lg:flex-row lg:items-center">
            {/* <img className="object-contain lg:w-full lg:h-full rounded-lg shadow" src={post.image} alt="" /> */}
            ...
            {/* <img className="object-contain h-[240px] w-[320px] rounded-lg shadow" src={post.image} alt="" /> */}
